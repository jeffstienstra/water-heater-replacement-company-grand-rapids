...
const description = "Grand Rapids' zero-commission water heater replacement specialists. We offer honest, upfront pricing for tank and tankless installations with a 2-year labor warranty.";
...
export const businessInfo: BusinessInfo = {
    ...
    social: {
        ...
        google: 'https://g.page/r/CZPZy9YX0GpqEAE/review',
    },
    logo: mainLogo,
    mainImage: {
        "@type": "ImageObject",
