...
export default function StickyBar({selectedModel, onConfirmClick}) {
	...
	return (
		<div className="fixed bottom-0 left-0 right-0 z-50 bg-primary text-white font-bold transition-all ease-in-out duration-500">
			<div className="flex flex-col items-center text-center px-4 py-4 sm:p-6">
				...
				>
					<button
						className="btn btn-outline bg-white text-primary font-bold w-full max-w-96 text-lg py-6 animate-pulse"
